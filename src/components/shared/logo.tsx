	...
	return (
		...
		>
			...
			<div className='relative flex items-center justify-center'>
				...
				{/* Основной LEGO блок */}
				<div className='relative bg-gradient-to-br from-red-500 to-red-600 rounded-2xl shadow-lg group-hover:shadow-xl transform group-hover:scale-110 transition-all duration-300 w-10 h-10 border-2 border-red-400/50 flex items-center justify-center'>
					{/* Центральная иконка */}
			...
			<div className='relative flex flex-col items-start justify-center'>
				...
				<div className='relative flex flex-col items-start'>
					...
					{/* Подпись */}
					<div className={cn(
						'text-xs font-medium mt-1 transition-opacity duration-300 flex items-center',
				...
				<div className='absolute -top-1 -right-2 flex space-x-1 items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
					<div className={cn(
			...
			<div className='absolute -bottom-1 -right-1 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center'>
				<div className='w-2 h-2 bg-gradient-to-br from-green-500 to-emerald-600 rounded shadow transform rotate-45 flex items-center justify-center'>
