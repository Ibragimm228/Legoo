...
export function TestimonialsSection() {
	return (
		<section className='relative py-24 sm:py-32 overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900'>
			...
			<div className='absolute top-20 left-16 animate-orbit'>
			...
			<div className='absolute top-40 right-20 animate-orbit delay-2000'>
			...
			<div className='absolute bottom-32 left-1/4 animate-orbit delay-4000'>
			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative'>
				...
				<div className='text-center mb-20'>
					...
					<div className='flex justify-center items-center mb-8'>
						<div className='relative'>
							<div className='flex items-center space-x-4 bg-white/10 backdrop-blur-xl rounded-2xl px-8 py-4 border border-purple-400/30 shadow-2xl'>
							...
							{/* Светящийся эффект */}
							<div className='absolute inset-0 bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 rounded-2xl opacity-30 blur-lg'></div>
						</div>
					</div>
					...
					<div className='relative mb-8'>
						...
						<div className='absolute -top-8 -right-8 w-6 h-6 bg-yellow-400 rounded-full opacity-60 animate-bounce'></div>
						<div className='absolute top-1/2 -left-8 w-4 h-4 bg-pink-400 rounded-full opacity-60 animate-bounce delay-500'></div>
					</div>
					...
					<div className='max-w-4xl mx-auto'>
						<div className='relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-purple-400/30'>
							...
							{/* Светящаяся граница */}
							<div className='absolute bottom-0 left-1/2 transform -translate-x-1/2 w-40 h-1 bg-gradient-to-r from-transparent via-purple-400 to-transparent rounded-full'></div>
						</div>
					</div>
					...
					<div className='grid grid-cols-1 sm:grid-cols-4 gap-6 mt-12 max-w-4xl mx-auto'>
						{[
							...
							<div key={index} className='relative group'>
								<div className='bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20 shadow-lg group-hover:shadow-2xl transition-all duration-300 transform group-hover:scale-105'>
				...
				<div className='relative'>
					...
					<div className='absolute inset-0 bg-gradient-to-r from-indigo-800/40 via-purple-800/40 to-pink-800/40 rounded-3xl transform rotate-1 scale-105 blur-sm'></div>
					
					<div className='relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-purple-400/30'>
						{/* Заголовок секции отзывов */}
						<div className='text-center mb-12'>
							<div className='inline-flex items-center space-x-3 bg-gradient-to-r from-indigo-500/20 to-pink-500/20 rounded-2xl px-8 py-4 border border-purple-300/30'>
								<div className='w-4 h-4 bg-indigo-400 rounded-full animate-pulse'></div>
								<h3 className='text-2xl font-bold text-white'>Builder Testimonials</h3>
							...
							{TESTIMONIALS.map((testimonial, index) => {
								...
								return (
									<div key={testimonial.author} className='relative group'>
										{/* Светящийся эффект */}
										<div className={`absolute -inset-3 bg-gradient-to-r ${gradients[index]} rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur`}></div>
										
										<div className={`relative bg-gradient-to-br ${gradients[index]} backdrop-blur-xl rounded-3xl p-8 ${glowColors[index]} shadow-2xl border-2 transform group-hover:scale-105 transition-all duration-300`}>
											{/* LEGO шипы */}
											<div className='absolute -top-4 left-8 flex space-x-3'>
												<div className={`w-8 h-8 bg-gradient-to-br ${chipColors[index]} rounded-full shadow-xl`}></div>
												<div className={`w-8 h-8 bg-gradient-to-br ${chipColors[index]} rounded-full shadow-xl`}></div>
												<div className={`w-8 h-8 bg-gradient-to-br ${chipColors[index]} rounded-full shadow-xl`}></div>
											</div>
											...
											<div className='flex justify-between items-start mb-6'>
												...
												<div className={`px-3 py-1 bg-gradient-to-r ${chipColors[index]} rounded-full text-white text-xs font-bold`}>
													VERIFIED BUILDER
												</div>
											</div>
											...
											<blockquote className='relative mb-8'>
												<div className='absolute -top-2 -left-2 text-6xl text-white/20 font-serif'>"</div>
												<p className='text-lg text-white/90 leading-relaxed relative z-10 italic'>
													{testimonial.quote}
												</p>
												<div className='absolute -bottom-4 -right-2 text-6xl text-white/20 font-serif rotate-180'>"</div>
											</blockquote>
											...
											<div className='flex items-center justify-between'>
												<div className='flex items-center space-x-4'>
													<div className='relative'>
														...
														/>
														<div className={`absolute -bottom-1 -right-1 w-6 h-6 bg-gradient-to-br ${chipColors[index]} rounded-full border-2 border-white flex items-center justify-center`}>
													...
													<div>
														...
														<p className={`text-xs font-bold bg-gradient-to-r ${chipColors[index]} bg-clip-text text-transparent`}>
												...
												<div className='text-right'>
													<div className={`inline-flex items-center space-x-2 bg-gradient-to-r ${chipColors[index]} rounded-lg px-3 py-2`}>
														...
														<span className='text-white text-sm font-bold'>{testimonial.builds}</span>
													</div>
												</div>
											</div>

											{/* Декоративная нижняя линия */}
											<div className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-32 h-1 bg-gradient-to-r ${chipColors[index]} rounded-full opacity-60`}></div>

											{/* Эффект блеска */}
											<div className='absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700 rounded-3xl'></div>
										</div>
									</div>
								)
							})}
						...
						<div className='mt-12 text-center'>
							<div className='inline-flex items-center space-x-4 bg-gradient-to-r from-indigo-600/20 to-pink-600/20 rounded-2xl px-8 py-4 border border-purple-400/30'>
